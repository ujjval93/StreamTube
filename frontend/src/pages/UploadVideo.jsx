  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        {required && (
          <span className="rounded-full bg-[#2a2a2a] px-3 py-1 text-[11px] uppercase tracking-[0.3em] text-[#ff6b6b]">
            Required
          </span>
        )}
      </div>
      ...
      <div className="mx-auto w-full max-w-6xl space-y-8">
        <div className="flex flex-col gap-4 rounded-[36px] border border-white/10 bg-[#0f0f0f] p-6 sm:p-8">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-[#888]">
                Upload Video
              </p>
              ...
              <p className="mt-2 text-sm text-[#aaa]">
                A modern uploader with preview, tags, category, and publish
                controls.
              </p>
            </div>
            <button
              ...
              {step === 1 && (
                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-between">
                  <p className="text-sm text-[#888]">
                    Ready? Continue to details and publish.
                  </p>
                  <button
                    type="button"
            ...
            <div className="rounded-[30px] border border-white/10 bg-[#121212] p-5">
              <div className="mb-5">
                ...
                <p className="mt-2 text-sm text-[#777]">
                  Your upload progress and metadata live here.
                </p>
              </div>
              <div className="space-y-4">
                <div className="rounded-3xl border border-white/10 bg-[#101010] px-4 py-4">
                  ...
                  <div className="mt-3 space-y-2 text-sm text-[#ccc]">
                    ...
                    <p>
                      Thumbnail:{" "}
                      {thumbnailFile ? thumbnailFile.name : "Not selected"}
                    </p>
            ...
            <div className="space-y-4">
              <div className="grid gap-4 lg:grid-cols-2">
                <label className="block">
                  <span className="text-xs uppercase tracking-[0.35em] text-[#888]">
                    Title
                  </span>
                  <input
                    type="text"
            ...
            <div className="rounded-[28px] border border-white/10 bg-[#101010] p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#141414] px-3 py-2 text-sm text-[#ddd]"
                  >
                    {tag}
                    <button
                      type="button"
                      onClick={() => removeTag(tag)}
                      className="rounded-full bg-white/5 p-1 text-white transition hover:bg-white/10"
                    >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex-1 rounded-[28px] border border-white/10 bg-[#101010] p-4">
                ...
                <div className="mt-3 flex flex-col gap-2 text-sm text-[#ccc]">
                  <p>
                    <span className="text-white">Privacy:</span> {privacy}
                  </p>
                  <p>
                    <span className="text-white">Category:</span> {category}
                  </p>
                  <p>
                    <span className="text-white">Tags:</span> {tags.length || 0}
                  </p>
                </div>
              </div>
              <button
                ...
                className="publish-video-btn inline-flex items-center justify-center gap-2 rounded-3xl bg-green-500 px-6 py-3 text-sm font-semibold text-black transition duration-200 disabled:cursor-not-allowed disabled:opacity-100 hover:bg-green-600"
              >
                {isUploading ? "Publishing..." : "Publish video"}
                {isUploading ? <FiUploadCloud /> : <FiUpload />}
              </button>
            </div>
