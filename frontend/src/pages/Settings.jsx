...
const SectionCard = ({ title, description, icon: Icon, children, accent }) => (
  ...
  >
    <div
      className={`px-6 py-5 border-b ${accent ? "border-red-500/10" : "border-white/6"}`}
    >
      <div className="flex items-center gap-3">
        {Icon && (
          ...
          >
            <Icon
              className={`text-sm ${accent ? "text-red-400" : "text-white/50"}`}
            />
          </div>
        )}
        <div>
          <h2
            className={`font-semibold text-sm ${accent ? "text-red-400" : "text-white"}`}
          >
            {title}
          </h2>
          {description && (
...
const InputField = ({ icon: Icon, label, error, ...props }) => (
  <div>
    ...
    <div className="relative">
      {Icon && (
        <Icon className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/20 text-sm" />
      )}
      <input
        {...props}
...
const SaveButton = ({
  ...
  <button
    ...
    className={`flex items-center gap-2 px-5 py-2.5 hover:bg-white/90 disabled:bg-white/10 disabled:cursor-not-allowed text-black disabled:text-white/40 text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-white/3 ${className}`}
  >
    {loading ? (
      <>
        <Spinner />
...
const Settings = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <SectionCard
        title="Channel Art"
        description="Customize how your channel looks"
        icon={FiCamera}
      >
        {/* Cover Image */}
        ...
        <div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <label
                htmlFor="avatarInput"
                className="inline-block mt-2 text-white/40 hover:text-white/70 text-xs cursor-pointer transition-colors underline underline-offset-2"
              >
      ...
      >
        ...
        >
          ...
          <div className="flex justify-end pt-2">
            ...
            >
              <FiSave className="text-sm text-orange-400" /> Save Changes
            </SaveButton>
          </div>
        </form>
      </SectionCard>
        ...
        >
          ...
          <div className="flex justify-end pt-2">
            <SaveButton
              ...
              className="bg-orange-400 hover:bg-orange-500 text-white"
            >
              <FiShield className="text-sm text-orange-400" />
              Change Password
            </SaveButton>
          </div>
        </form>
